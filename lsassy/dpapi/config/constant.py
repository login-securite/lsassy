...
class constant():
    ...
    profile = {
        'ALLUSERS': u'\\Users',
        'APPDATA': u'\\Users\\{user}\\AppData\\Roaming\\',
        'USERPROFILE': u'\\Users\\{user}\\',
        'HOMEDRIVE': u'',
        'HOMEPATH': u'\\Users\\{user}',
        'ALLUSERSPROFILE': u'\\ProgramData',
        'COMPOSER_HOME': u'\\Users\\{user}\\AppData\\Roaming\\Composer\\',
        'LOCALAPPDATA': u'\\Users\\{user}\\AppData\\Local',
    }
    username = u''
    keepass = {}
    hives = {
